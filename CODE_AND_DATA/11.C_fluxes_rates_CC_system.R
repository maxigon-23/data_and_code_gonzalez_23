...
fun_error_prop <- function(pars){
  ...
  model_output_1$total_release <- model_output_1$C_POM_release +  model_output_1$C_MAOM_release
  model_output_1$stabilization_flux <-  model_output_1$C_POM * alpha_2_1*pars[1]
  model_output_1$mineraliz_prop <- model_output_1$total_release / model_output_1$C_ha_mean
  model_output_1$mineraliz_MAOM_prop <- model_output_1$C_MAOM_release / model_output_1$C_MAOM
  
  model_output_1$stabilization_efficiency <- model_output_1$stabilization_flux / inputVector[1]
  ...
  model_output_2$total_release <- model_output_2$C_POM_release +  model_output_2$C_MAOM_release
  model_output_2$stabilization_flux <-  model_output_2$C_POM * alpha_2_1*pars[1]
  model_output_2$mineraliz_prop <- model_output_2$total_release / model_output_2$C_ha_mean
  model_output_2$mineraliz_MAOM_prop <- model_output_2$C_MAOM_release / model_output_2$C_MAOM
  
  model_output_2$stabilization_efficiency <- model_output_2$stabilization_flux / inputVector[1]
...
write.xlsx(export, "sens_var_outputs/sesns_var_output_CC_tasas.xlsx", colWidths = c("auto", "auto"),overwrite=TRUE) #Exporta en arhivo .xlsx la lista creada anteriormente.
